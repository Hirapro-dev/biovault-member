    ...
    <div>
      ...
      >
        <article className="text-xs sm:text-sm text-text-secondary leading-[2] space-y-6">
          ...
          <p>株式会社SCPP（以下「当社」という。）は、BioVault会員制サービス（以下「本サービス」という。）の申込みに先立ち、申込者に対し、以下の重要事項を説明します。</p>
          ...
          <Section title="第2条（本サービスの位置付け）">
            <p>本サービスは、会員本人に由来する血液その他検体に関し、提携医療機関、提携加工施設、提携保管施設その他提携先における細胞の作製、加工、保管その他関連手続について、当社から案内、申込管理、日程調整、情報提供および運営上の連携を受ける会員制サービスです。</p>
          ...
          <Section title="第5条（本サービスが医療契約そのものではないこと）">
            <p>本サービスに関する会員契約は、会員制サービスの利用契約であり、医療行為そのものの直接提供契約ではありません。</p>
          ...
          <p>株式会社SCPP（以下「甲」という。）は、BioVault会員制サービス（以下「本サービス」という。）の提供にあたり、申込者兼会員（以下「乙」という。）の個人情報、要配慮個人情報、個人遺伝情報その他本サービスに関連して取得する情報を、以下のとおり取り扱います。</p>
          ...
          <Section title="第7条〜第14条">
            <p>共同利用（第7条）、保存期間（第8条）、安全管理措置（第9条）、開示・訂正・利用停止等（第10条）、不同意または同意撤回の取扱い（第11条）、サービス改善・品質管理への任意同意（第12条）、研究開発利用への任意同意（第13条）、案内配信・イベント通知への任意同意（第14条）については、各条項に従うものとします。</p>
          </Section>
        </article>
      </div>

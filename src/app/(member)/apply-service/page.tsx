...
function TermsContent() {
  return (
    <>
      ...
      <TS t="第5条（メンバーシップ資格）"><p>メンバーシップ資格は、当社が申込みを承認した時点で発生します。</p><p>メンバーシップ資格は、申込みまたは契約締結のみをもって、採血、加工、保管、施術その他個別サービスの実施を当然に確定させるものではありません。</p><p>メンバーシップ資格はメンバーシップ登録者本人に専属し、第三者へ譲渡できません。</p></TS>
      <TS t="第6条（本サービスの内容）"><p>本サービスの中核は、CellAssetに関する案内、申込管理、連絡調整、提供連携および関連するメンバーシップ登録者向け付随サービスとします。</p></TS>
      <TS t="第7条（メンバーシップ限定サービス）"><p>当社は、メンバーシップ登録者に対し、情報配信サービス、個別相談またはコンシェルジュ案内、メンバーシップ限定イベント、提携先優待または紹介サービス等を提供することがあります。</p></TS>
      <TS t="第8条（メンバーシップ登録者情報の管理）"><p>メンバーシップ登録者は、届出情報に変更があった場合、速やかに届け出るものとします。</p></TS>
      <TS t="第9条（利用条件）"><p>本サービスは、メンバーシップ登録者本人のために提供されるものであり、第三者に利用させることはできません。</p></TS>
      <TS t="第10条（禁止事項）"><p>メンバーシップ登録者は、法令違反、虚偽申告、権利侵害、業務妨害、反社会的勢力への利益供与等を行ってはなりません。</p></TS>
      <TS t="第11条（知的財産権）"><p>本サービスに関連する知的財産権は、当社または正当な権利者に帰属します。</p></TS>
      <TS t="第12条（秘密保持）"><p>メンバーシップ登録者は、本サービスに関連して知り得た非公知情報を第三者に開示してはなりません。</p></TS>
      <TS t="第13条（個人情報等の取扱い）"><p>当社は、メンバーシップ登録者の個人情報を法令、関連文書およびプライバシーポリシーに従って取り扱います。</p></TS>
      <TS t="第14条（情報配信）"><p>当社は、運営上必要な通知を電子メール等により行うことができます。</p></TS>
      <TS t="第15条（メンバーシップ資格の停止・喪失）"><p>規約違反、虚偽申告、料金未払い等の場合、メンバーシップ資格を停止または喪失させることができます。</p></TS>
      <TS t="第16条（メンバーシップ登録者による退会等）"><p>メンバーシップ登録者は、当社所定の方法により退会または解約を申し出ることができます。</p></TS>
      <TS t="第17条（死亡時の取扱い）"><p>メンバーシップ登録者が死亡したときは、メンバーシップ資格は当然に終了します。</p></TS>
      <TS t="第18条（規約の変更）"><p>当社は、法令改正、監督官庁の指導、提携条件の変更、サービス内容の合理的見直し等の事由がある場合、本規約を変更することができます。</p></TS>
      <TS t="第19条（免責）"><p>当社は、本サービスに関して、特定の美容上、健康上、医療上、経済上またはその他の結果、効果、効能を保証しません。</p></TS>
      <TS t="第20条（反社会的勢力の排除）"><p>メンバーシップ登録者は、反社会的勢力に該当しないことを表明し、保証します。</p></TS>
      <TS t="第21条（協議事項）"><p>本規約に定めのない事項は、誠実に協議して解決するものとします。</p></TS>
      <TS t="第22条（準拠法・管轄）"><p>本規約は日本法に準拠します。紛争が生じた場合、当社本店所在地を管轄する地方裁判所または簡易裁判所を第一審の専属的合意管轄裁判所とします。</p></TS>
    </>
  );
}

...
export type MemberRow = {
  ...
  scheme: "SCPP" | "MRT";                  // 流入スキーム（契約主体の会社）
...
/** スキーム別のバッジ色 */
const SCHEME_BADGE: Record<"SCPP" | "MRT", string> = {
  SCPP: "bg-blue-900/30 text-blue-300 border-blue-500/40",
  MRT:  "bg-orange-900/30 text-orange-300 border-orange-500/40",
};
            ...
            <div key={r.id} className="bg-bg-secondary border border-border rounded-md p-4">
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-2">
                  ...
                  <span className={`text-[9px] px-1.5 py-0.5 rounded-sm border ${SCHEME_BADGE[r.scheme]}`}>
                    {r.scheme}
                  </span>
                </div>

 ...
 * - 送信成功時は スキームに応じた contact/thanks へ遷移
 * - /m/form/contact から本ファイルが再エクスポートされ、MRT スキームとして動作する。
 */
...
import { detectSchemeFromPath, getSchemePathPrefix } from "@/lib/scheme";
...
function ContactPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      router.push(`${getSchemePathPrefix(scheme)}/form/contact/thanks`);
    } catch {

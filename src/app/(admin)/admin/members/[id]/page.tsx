      ...
      {adminUser.role === "SUPER_ADMIN" && (
        <SuperAdminEditSection
          ...
          user={{
            ...
            currentIllnessDetail: user.currentIllnessDetail || null,
            pastIllness: user.pastIllness,
            pastIllnessDetail: user.pastIllnessDetail || null,
            currentMedication: user.currentMedication,
            currentMedicationDetail: user.currentMedicationDetail || null,
            chronicDisease: user.chronicDisease,
            chronicDiseaseDetail: user.chronicDiseaseDetail || null,
            infectiousDisease: user.infectiousDisease,
            infectiousDiseaseDetail: user.infectiousDiseaseDetail || null,
            pregnancy: user.pregnancy,
            allergy: user.allergy,
            allergyDetail: user.allergyDetail || null,
            otherHealth: user.otherHealth,
            otherHealthDetail: user.otherHealthDetail || null,
          }}
          membership={membership ? {
            ...
            clinicPhone: membership.clinicPhone || null,
            ...
            contractFormat: membership.contractFormat || null,
            deathWish: membership.deathWish || null,
            referrerName: membership.referrerName || null,
          } : null}
        />
      )}

...
function ImportantNoticeContent() {
  return (
    <article className="text-xs sm:text-sm text-text-secondary leading-[2] space-y-6">
      ...
      <S t="第1条（本書の目的）">
        <p>本書は、BioVaultメンバーシップ契約書、BioVaultメンバーシップ規約その他関連文書に先立ち、申込者が本サービスの内容、性質、提供条件、費用、制約、個人情報の取扱いその他重要事項を正しく理解するために交付されるものです。</p>
      </S>
      <S t="第2条（本サービスの位置付け）">
      ...
      <S t="第9条（費用）">
        <p>本サービスのメンバーシップ価格は、別途メンバーシップ契約書または申込確認書に定める金額とします。</p>
      </S>
...
function PrivacyConsentContent() {
  return (
    <article className="text-xs sm:text-sm text-text-secondary leading-[2] space-y-6">
      <p>株式会社SCPP（以下「甲」という。）は、BioVault制サービス（以下「本サービス」という。）の提供にあたり、申込者兼メンバーシップ（以下「乙」という。）の個人情報、要配慮個人情報、個人遺伝情報その他本サービスに関連して取得する情報を、以下のとおり取り扱います。</p>
      ...
      <S t="第5条（必須利用目的）">
        ...
        <ul className="list-none space-y-1 pl-2">
          ...
          <li>(2) メンバーシップ契約書、メンバーシップ規約、重要事項説明書その他関連文書に基づく本サービスの運営のため</li>
